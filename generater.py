...
page_css = """
    .nav-pills {
        ...
        --bs-nav-pills-link-active-bg: #8AA150;
    }

    :root {
        --bs-link-color: #8AA150;
        --bs-link-hover-color: #515e2e;
    }

    .btn-primary {
        --bs-btn-bg: #8AA150;
        --bs-btn-border-color: #8AA150;
        --bs-btn-hover-bg: #515e2e;
        --bs-btn-hover-border-color: #515e2e;
    }

    .form-control:focus {
        border-color: #8aa15000;
